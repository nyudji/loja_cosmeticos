...
def page_dashboard_logic(df_movimento, df_produtos):
    ...
    col_kpi_7.metric("Quantidade em Estoque", f"{total_quantidade_estoque:,}")
    col_kpi_8.metric("Custo do Estoque", f"R$ {total_valor_custo_estoque:,.2f}".replace(",", "X").replace(".", ",").replace("X", "."))
